...
class DoublePendulumModelV2(TFModelV2, ABC):
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        super(DoublePendulumModelV2, self).__init__(obs_space, action_space, num_outputs, model_config, name)
        self._value_out = None
        input_layer = tf.keras.layers.Input(shape=obs_space.shape, name="observations")
        hidden_layer = input_layer
        for i in range(3):
...
class DoublePendulumModelV4(TFModelV2, ABC):
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        super(DoublePendulumModelV4, self).__init__(obs_space, action_space, num_outputs, model_config, name)
        self._value_out = None
        input_layer = tf.keras.layers.Input(shape=obs_space.shape, name="observations")
        hidden_layer = input_layer
        for i in range(2):
